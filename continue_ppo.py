...
from my_utilities import get_action_from_target_policy, my_mlp_actor_critic
from my_test_policy import load_policy_and_env, load_tf_policy
...
if __name__ == '__main__':
    fpath = "/home/shawn/Documents/DRL/experiments/Tue Apr 28 22:50:31 2020"
    itr = 'last'
    deterministic = False
    epi_len = None
    # epi_len = 200
    ...
    env, get_action = load_policy_and_env(fpath,
                                          itr,
                                          deterministic)
    writer = tf.summary.FileWriter("/home/shawn/Documents/DRL/tmp_log2", tf.get_default_graph())
    writer.close()
